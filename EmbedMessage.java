...
public class EmbedMessage extends JFrame implements ActionListener {
	...
	private final JButton btnDecode = new JButton("Decode");
...
//       getMaximumWindowBounds());
		...
		gl_p.setHorizontalGroup(
			gl_p.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_p.createSequentialGroup()
					...
					.addComponent(save)
					.addGap(18)
					.addComponent(btnDecode, GroupLayout.PREFERRED_SIZE, 112, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
	...
	private void embedMessage() {
		...
		this.validate();
		try {
	    	FileWriter writer= new FileWriter("C:\\Users\\HP\\Desktop\\stegano.txt",true);
	    	BufferedWriter bufferwrite=new BufferedWriter(writer);
	    	bufferwrite.write("Secret message: ");
